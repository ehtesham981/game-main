                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-[0.2em] transition-all duration-300 whitespace-nowrap flex items-center gap-2.5 ${currentPage === 'micro-jobs' || currentPage === 'tasks' || currentPage === 'math-solver' || currentPage === 'spin' || currentPage === 'weekly-bonus'
                          ? 'text-indigo-600 bg-white shadow-lg shadow-slate-200/50 ring-1 ring-slate-100'
                          : 'text-slate-500 hover:text-slate-900 hover:bg-white/40'
                          }`}
                      >
                        <i className={`fa-solid ${link.icon} text-[10px] ${currentPage === 'micro-jobs' || currentPage === 'tasks' || currentPage === 'math-solver' || currentPage === 'spin' || currentPage === 'weekly-bonus' ? 'opacity-100' : 'opacity-40'}`}></i>
                        {link.name}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`flex items-center gap-4 pl-5 pr-1.5 py-1.5 rounded-[1.5rem] border transition-all shadow-sm active:scale-95 ${isUserMenuOpen ? 'bg-indigo-50 border-indigo-200' : 'bg-white border-slate-200 hover:border-slate-300'
                        }`}
                    >
                      <div className="flex flex-col items-start">
